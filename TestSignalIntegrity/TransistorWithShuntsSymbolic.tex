...
\[ \mathbf{T}=\left(\begin{smallmatrix} \frac{r_o\cdot r_{\pi}+Z0\cdot
...
\[ \mathbf{W_{ba}} = \left(\begin{smallmatrix} rb_{11} & 0 & 0 & 0 \\
...
\end{smallmatrix}\right) \]
\[ \mathbf{W_{xx}} = \left(\begin{smallmatrix} 0 & 0 & 0 & Cps_{11} &
