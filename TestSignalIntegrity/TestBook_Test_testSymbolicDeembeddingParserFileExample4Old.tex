...
A_{12} \end{smallmatrix}\right)^H\cdot\left[ \left(\begin{smallmatrix}
A_{11} & A_{12} \end{smallmatrix}\right)\cdot\left(\begin{smallmatrix}
A_{11} & A_{12} \end{smallmatrix}\right)^H\right]^{-1} \]
\[ \mathbf{?2}= \left(\begin{smallmatrix} B_{21} & B_{22}
\end{smallmatrix}\right)\cdot \left(\begin{smallmatrix} A_{21} &
A_{22} \end{smallmatrix}\right)^H\cdot\left[ \left(\begin{smallmatrix}
A_{21} & A_{22} \end{smallmatrix}\right)\cdot\left(\begin{smallmatrix}
