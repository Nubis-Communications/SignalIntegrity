...
class TestSources(unittest.TestCase):
    ...
    def testOperationalAmplifierAgain(self):
        ...
        sdp.AddLines(['device VA 4',
            ...
            'connect ZI2 2 G 1'])
        sd = sdp.SystemDescription()
        #sd.AssignSParameters('VA',si.sy.VoltageAmplifierFourPort('G','Z_d','Z_o'))
        sd.AssignSParameters('VA',si.sd.Device.SymbolicMatrix('VA',4))
        #sd.AssignSParameters('ZI1',si.sy.SeriesZ('Z_i'))
        sd.AssignSParameters('ZI1',si.sd.Device.SymbolicMatrix('Zi',2))
        #sd.AssignSParameters('ZI2',si.sy.SeriesZ('Z_i'))
        sd.AssignSParameters('ZI2',si.sd.Device.SymbolicMatrix('Zi',2))
        ssp=si.sd.SystemSParameters(sdp.SystemDescription())
        ssps=si.sd.SystemSParametersSymbolic(ssp,True,True)
        print 'ZI1 = ZI2 = '+ si.sy.SeriesZ('Z_i')
        print 'VA = ' + si.sy.VoltageAmplifierFourPort('G','Z_d','Z_o')
        ssps.LaTeXBigSolution().Emit()
        # exclude
