...
class TestCascadingTest(unittest.TestCase):
    ...
    def testCascading(self):
        ...
        T=[[T11,T12],[T21,T22]]=(matrix(TL)*matrix(TR)).tolist()
        S=[[S11,S12],[S21,S22]]=si.cvt.T2S(T)
        # this is presumably the right answer
        #
        # now check the math in the book
        TLc=[[TLc11,TLc12],[TLc21,TLc22]]=(1./SL21*matrix([[-det(matrix(SL)),SL11],[-SL22,1.]])).tolist()
        ...
        TRc=[[TRc11,TRc12],[TRc21,TRc22]]=(1./SR21*matrix([[-det(matrix(SR)),SR11],[-SR22,1.]])).tolist()
        ...
        Tc=[[Tc11,Tc12],[Tc21,Tc22]]=(1./(SL21*SR21)*matrix([[det(matrix(SL))*det(matrix(SR))-SL11*SR22,SL11-det(matrix(SL))*SR11],
                                                            [det(matrix(SR))*SL22-SR22,1.-SL22*SR11]])).tolist()
        ...
        Sc=[[Sc11,Sc12],[Sc21,Sc22]]=(1./T22*matrix([[T12,det(matrix(T))],[1.,-T21]])).tolist()
        ...
        Sc=[[Sc11,Sc12],[Sc21,Sc22]]=(1./(1.-SL22*SR11)*matrix([[SL11-SR11*det(matrix(SL)),SL12*SR12],
                                                                [SL21*SR21,SR22-SL22*det(matrix(SR))]])).tolist()
        self.assertAlmostEqual(Sc11, S11, 12, 'S11 incorrect')
        self.assertAlmostEqual(Sc12, S12, 12, 'S12 incorrect')
        self.assertAlmostEqual(Sc21, S21, 12, 'S21 incorrect')
        self.assertAlmostEqual(Sc22, S22, 12, 'S22 incorrect')
