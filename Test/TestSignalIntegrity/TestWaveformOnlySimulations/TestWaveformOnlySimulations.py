"""
TestWaveformOnlySimulations.py
"""
...
class TestWaveformOnlySimulationsTest(unittest.TestCase,
    ...
    def testWaveformOnlyProjectAsSource(self):
        self.SimulationResultsChecker('PRBSTestCompareOnlyWaveformAsSourceTest.si')
