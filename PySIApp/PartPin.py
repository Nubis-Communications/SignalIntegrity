...
class PartPin(object):
    def __init__(self,pinNumber,pinConnectPoint,pinOrientation,pinNumberVisible=True):
...
class PartPinXMLClassFactory(PartPin):
    def __init__(self,xml):
        ...
        self.result=PartPin(pinNumber,pinConnectionPoint,pinOrientation,pinNumberVisible)
