...
class FractionalDelayFilterSinXOld(FirFilter):
...
class UpsamplerSinXOld(FirFilter):
    def __init__(self,U):
        from FilterDescriptor import FilterDescriptor
        K=128
        F=0.
...
class UpsamplerFractionalDelayFilterSinXOld(object):
