...
class PartPropertyFileName(PartProperty):
    def __init__(self,fileName=''):
        PartProperty.__init__(self,'filename',type='file',unit=None,keyword='file',description='file name',value=fileName,visible=True)
...
class PartPropertySubprojectName(PartProperty):
    def __init__(self,subprojectName=None,hidden=True):
