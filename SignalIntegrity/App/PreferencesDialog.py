...
class PreferencesDialog(PropertiesDialog):
    def __init__(self, parent,preferences):
        ...
        self.archiveNonRelativeFiles = CalculationPropertyTrueFalseButton(self.propertyListFrame,'archive non-relative files',None,self.onUpdatePreferences,preferences,'ProjectFiles.ArchiveNonRelativeFiles')
        self.regressionEnabled = CalculationPropertyTrueFalseButton(self.propertyListFrame,'enable regression tools',None,self.onUpdatePreferences,preferences,'Features.Regression')
        self.regressionOpenDiffTool = CalculationPropertyTrueFalseButton(self.propertyListFrame,'open meld on regression failure',None,self.onUpdatePreferences,preferences,'Regression.OpenDiffToolOnFailure')
