...
class SParameterPropertiesDialog(PropertiesDialog):
    def __init__(self,parent,project):
        ...
        self.referenceImpedanceFrame=CalculationPropertySI(self.referenceImpedanceEntryFrame,'Reference Impedance',None,None,self.project,'ReferenceImpedance','Ohm')
